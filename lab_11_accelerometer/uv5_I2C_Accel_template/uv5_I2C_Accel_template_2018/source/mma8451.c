...
int init_mma()
{
	  //check for device and configure accel. device address (MMA_ADDR) and register address (REG_WHOAMI)
...
void read_full_xyz()
{
	...
	i2c_start();
	i2c_read_setup(MMA_ADDR , REG_XHI);// configure slave address for read and slave register for read
